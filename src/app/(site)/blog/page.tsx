      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Exploring the latest developments, techniques, and perspectives in modern neurosurgery
          </p>
        </div>
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {featuredPosts.map((post) => (
                <Card key={post.id} className="group overflow-hidden hover:shadow-xl transition-all duration-300 border-0 shadow-lg dark:bg-gray-800">
                  <div className="p-8">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {recentPosts.map((post) => (
              <Card key={post.id} className="group overflow-hidden hover:shadow-lg transition-all duration-300 dark:bg-gray-800">
                <div className="p-6">
        ...
        <section className="mt-20">
          <Card className="bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-700 dark:to-purple-700 border-0 text-white">
            <div className="p-12 text-center">
              <h3 className="text-3xl font-bold mb-4">Stay Updated</h3>
              <p className="text-xl mb-8 text-blue-100">
                Get the latest insights in neurosurgery delivered to your inbox
              </p>
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="flex-1 px-4 py-3 rounded-lg text-gray-900 dark:text-white bg-white/20 dark:bg-gray-800/50 border border-white/30 placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/50"
                />
