  ...
  return (
    <section className="relative space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32 overflow-hidden">
      ...
      <div className="container flex max-w-[64rem] flex-col items-center gap-6 text-center">
        ...
        <h1 className="font-bold text-3xl sm:text-5xl md:text-6xl lg:text-7xl animate-fade-in opacity-0 [animation-delay:0.4s] [animation-fill-mode:forwards] bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900 dark:from-white dark:via-blue-100 dark:to-purple-100 bg-clip-text text-transparent">
          {profile?.fullName || 'Ishan Perera'}
        </h1>
        
        {/* Subtitle with animation */}
        <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8 animate-fade-in opacity-0 [animation-delay:0.6s] [animation-fill-mode:forwards]">
          {profile?.currentTitle || 'Medical Student • Researcher • Business Owner • Developer'}
        </p>
        
        {/* CTA buttons with hover animations */}
        <div className="flex flex-col sm:flex-row gap-4 animate-fade-in opacity-0 [animation-delay:0.8s] [animation-fill-mode:forwards]">
